...
requireLogin(); // Agora, sempre exige login para acessar a busca
    ...
    <div class="container">
        ...
        <div class="search-filters">
            ...
            <div class="quick-filters">
                ...
                <a href="search_disks.php?filter=favorite"
...
.quick-filters {
    ...
    justify-content: center;
    flex-wrap: wrap;
    margin-top: 1.5rem; /* Adicionado para separar dos botões de ação */
}
.quick-filter {
    display: flex;
    align-items: center;
...
@media (max-width: 480px) {
    ...
    .disk-actions {
        flex-direction: row; /* Mantém os botões lado a lado no mobile para economizar espaço */

...
// NOTA: Toda a lógica relacionada a "visualização de coleções compartilhadas no índice" foi removida.
    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <?php if (isLoggedIn()): ?>
                    <?php
                    // Usar o user_id logado para as estatísticas
        ...
        <div class="container">
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p>Registre CDs, LPs e BoxSets com todas as informações detalhadas: edição, país de
                        origem, condição e muito mais.</p>
                ...
                <div class="feature-card">
                    ...
                    <p>Pesquise sua coleção por artista, álbum, tipo de mídia, condição e outros filtros
                        para encontrar o que procura em segundos.</p>
                    <div class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <p>Identifique discos importados, registre o país e continente de origem, e evite falsificações
                        com alertas inteligentes.</p>
                    <div class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <p>Classifique seus discos de acordo com padrões internacionais: de "Bom" até "Mint"
                        para garantir a melhor catalogação.</p>
                    <div class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <p>Cadastre edições limitadas e enumeradas com todos os brindes e itens extras incluídos,
                        mantendo o valor da sua coleção.</p>
                    <div class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <h3>Estatísticas</h3>
                    <p>Acompanhe o crescimento da sua coleção com gráficos e estatísticas detalhadas, incluindo
                        tipos de mídia, origens e condições.</p>
                    <div class="feature-link">

...
// Recarrega os dados do disco após uma tentativa de POST falha
$disk = getDiskById($pdo, $disk_id, $_SESSION['user_id']);
                    ...
                    <div class="discogs-search-container">
                        <div class="search-input-group">
                            <input type="text" id="discogs_search" class="form-input" 
                                   placeholder="Digite o nome do artista e álbum..." 
                                   value="<?php echo htmlspecialchars($disk['artist'] . ' ' . $disk['album_name']); ?>">

...
<main class="main">
    <div class="container">
        ...
        <nav class="breadcrumb">
            ...
            <a href="search_disks.php"> <i class="fas fa-search"></i> Minha Coleção </a>
            <i class="fas fa-chevron-right"></i>
                ...
                <div class="disk-title-section">
                    <div class="disk-badges-header">
                        ...
                        <?php if ($disk['is_sealed']): ?>
                            <span class="sealed-badge"> <i class="fas fa-certificate"></i> Lacrado </span>
                        <?php endif; ?>
                        <?php if ($disk['is_imported']): ?>
                            <span class="imported-badge"> <i class="fas fa-globe"></i> Importado </span>
                        <?php endif; ?>
                        <?php if ($disk['is_favorite']): // Badge de favorito ?>
                            <span class="favorite-badge"> <i class="fas fa-star"></i> Favorito </span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="disk-meta">
                        <?php if ($disk['year']): ?>
                            <span class="meta-item"> <i class="fas fa-calendar"></i> <?php echo $disk['year']; ?> </span>
                        <?php endif; ?>
                        <?php if ($disk['label']): ?>
                            <span class="meta-item"> <i class="fas fa-building"></i> <?php echo htmlspecialchars($disk['label']); ?> </span>
                        <?php endif; ?>
                        <span class="meta-item"> <i class="fas fa-bookmark"></i> <?php echo formatEdition($disk['edition']); ?> </span>
                        <span class="meta-item"> <i class="fas fa-clock"></i> Adicionado em <?php echo date('d/m/Y', strtotime($disk['created_at'])); ?> </span>
                    </div>
                </div>
            </div>
            <div class="disk-actions">
                <a href="search_disks.php" class="btn btn-secondary"> <i class="fas fa-arrow-left"></i> Voltar </a>
                ...
                <a href="edit_disk.php?id=<?php echo $disk['id']; ?>" class="btn btn-warning"> <i class="fas fa-edit"></i> Editar </a>
            </div>
        </div>
        ...
        <div class="disk-details-container">
            <div class="details-grid">
                ...
                <div class="detail-section">
                    <h3 class="section-title"> <i class="fas fa-info-circle"></i> Informações Gerais </h3>
                    <div class="detail-content">
                        <div class="detail-row">
                            <span class="detail-label">Tipo:</span> <span class="detail-value"><?php echo $disk['type']; ?></span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">Artista:</span> <span class="detail-value"><?php echo htmlspecialchars($disk['artist']); ?></span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">Álbum:</span> <span class="detail-value"><?php echo htmlspecialchars($disk['album_name']); ?></span>
                        </div>
                        <?php if ($disk['year']): ?>
                            <div class="detail-row">
                                <span class="detail-label">Ano:</span> <span class="detail-value"><?php echo $disk['year']; ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if ($disk['label']): ?>
                            <div class="detail-row">
                                <span class="detail-label">Gravadora:</span> <span class="detail-value"><?php echo htmlspecialchars($disk['label']); ?></span>
                            </div>
                        <?php endif; ?>
                        <div class="detail-row">
                            <span class="detail-label">Edição:</span> <span class="detail-value"><?php echo formatEdition($disk['edition']); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Origem -->
                <div class="detail-section">
                    <h3 class="section-title"> <i class="fas fa-globe"></i> Origem </h3>
                    <div class="detail-content">
                        <div class="detail-row">
                                ...
                                <span class="detail-value">
                                    ...
                                    <?php if ($disk['is_fake_prone']): ?>
                                        <span class="warning-badge">
                                            <i class="fas fa-exclamation-triangle"></i> Atenção: Falsificações
                                        </span>
                                    <?php endif; ?>
                                </span>
                            </div>
                            <div class="detail-row">
                                <span class="detail-label">Continente:</span> <span class="detail-value"><?php echo htmlspecialchars($disk['continent']); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <!-- Condição -->
                <div class="detail-section">
                    <h3 class="section-title"> <i class="fas fa-star"></i> Condição </h3>
                    <div class="detail-content">
                        <div class="detail-row">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value">
                                <?php if ($disk['is_sealed']): ?>
                                    <span class="sealed-status"> <i class="fas fa-certificate"></i> Lacrado </span>
                                <?php else: ?>
                                    <span class="unsealed-status"> <i class="fas fa-unlock"></i> Aberto </span>
                                <?php endif; ?>
                            </span>
                        </div>
                        <!-- Status de favorito -->
                        <div class="detail-row">
                            ...
                            <span class="detail-value">
                                <?php if ($disk['is_favorite']): ?>
                                    <span class="favorite-status active"> <i class="fas fa-heart"></i> Sim </span>
                                <?php else: ?>
                                    <span class="favorite-status"> <i class="far fa-heart"></i> Não </span>
                                <?php endif; ?>
                ...
                <!-- Itens Extras -->
                <div class="detail-section">
                    <h3 class="section-title"> <i class="fas fa-gift"></i> Itens Extras </h3>
                    <div class="detail-content">
                        <div class="extras-list">
                            ...
                            $extras = [
                                ...
                                'has_obi' => ['icon' => 'book-reader', 'label' => 'OBI (Faixa)'] // Adicionado: OBI
                            ];
                            $has_extras = false;
                            ...
                            if (!$has_extras && empty($disk['other_extras'])): ?>
                                <div class="no-extras">
                                    <i class="fas fa-minus-circle"></i> <span>Nenhum item extra</span>
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <?php if ($disk['type'] === 'BoxSet'): ?>
                    <div class="detail-section boxset-section">
                        <h3 class="section-title"> <i class="fas fa-crown"></i> Detalhes do BoxSet </h3>
                        <div class="detail-content">
                            <div class="detail-row">
                                <span class="detail-label">Tipo:</span>
                                <span class="detail-value">
                                    <?php if ($disk['is_limited_edition']): ?>
                                        <span class="limited-badge"> <i class="fas fa-gem"></i> Edição Limitada </span>
                                    <?php else: ?>
                                        BoxSet Regular
                                    <?php endif; ?>
                                </span>
                            ...
                            <?php if ($disk['is_limited_edition']): ?>
                                <?php if ($disk['edition_number']): ?>
                                    <div class="detail-row">
                                        <span class="detail-label">Número:</span> <span class="detail-value">#<?php echo $disk['edition_number']; ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if ($disk['total_editions']): ?>
                                    <div class="detail-row">
                                        <span class="detail-label">Total:</span> <span class="detail-value"><?php echo number_format($disk['total_editions'], 0, ',', '.'); ?></span>
                                    </div>
                                <?php endif; ?>
        ...
        <div class="disk-bottom-actions">
            <a href="search_disks.php" class="btn btn-secondary"> <i class="fas fa-search"></i> Ver Mais Discos </a>
            <a href="register_disk.php" class="btn btn-primary"> <i class="fas fa-plus-circle"></i> Cadastrar Outro Disco </a>
        </div>
    </div>
</main>
<style>
    ...
    .disk-main-info {
        ...
        flex: 1;
        min-width: 280px;
        /* Garante que não fique muito estreito */
    }
    ...
    .disk-actions .btn {
        min-width: 120px;
        /* Garante que os botões tenham largura mínima */
    }
    ...
    @media (max-width: 768px) {
        ...
        .detail-row {
            ...
            gap: 0.5rem;
            text-align: left;
            /* Mantém alinhamento para detalhes */
            align-items: flex-start;
        }

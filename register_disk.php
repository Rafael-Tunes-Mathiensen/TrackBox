                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="autocomplete-container">
                                <input type="text" id="artist" name="artist" class="form-input autocomplete-input"
                        ...
                        <div class="form-group">
                            ...
                            <div class="autocomplete-container">
                                <input type="text" id="label" name="label" class="form-input autocomplete-input"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createDiscogsResultElement(result) {
        ...
        const formats = result.formats && result.formats.length > 0 
            ? result.formats.map(f => f.name).join(', ') 
            : result.type;
        ...
        div.innerHTML = `
            <div class="result-content">
                <img src="${result.image_url || 'assets/images/no-cover.png'}" 
                     alt="Capa" 
                     class="result-image" 
    ...
    function markAutoFilledFields() {
        const autoFilledFields = [
            'artist', 'album_name', 'year', 'label', 'observations'
        ];
